...
export function Hero() {
  return (
    <section className="animate-in fade-in slide-in-from-bottom-2 relative overflow-hidden rounded-xl bg-neutral-950 px-6 py-16 text-center text-white duration-500 sm:py-24">
